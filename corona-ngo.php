     ...
     <div id="breadcrumb">
			 <div class="container">
				 <ul>
					 ...
					 <li><a href="corona-ngo.php">NGO WORKING ON CORONA</a></li>
			 ...
			 <div class="row">
					 ...
					 <div class="box_general_3 booking">
						 <form>
							 ...
							 <ul class="treatments clearfix">
							 	<?php  $query1="SELECT * FROM ngo where (status='0' && corona='yes') ";
				 ...
				 <div class="col-lg-8">
					 ...
					 <div class="strip_list wow fadeIn">
						 ...
						 <a href="ngo_details.php?id=<?=$row['id'];?>" style="color:black;">
