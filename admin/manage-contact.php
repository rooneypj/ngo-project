                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="valigntop">
                              ...
                              <a href="delete-contact.php?id=<?php echo $row['id']?>"><button type="submit" data-toggle="modal" data-target="#delete_employee" class="btn btn-danger btn-sm mb-1"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
                           </td>
                        </tr>
                         </tbody>
                        <?php } ?> 
