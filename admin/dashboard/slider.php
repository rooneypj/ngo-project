...
<tr>
                                                            ...
                                                            <td><img  src="<?php  echo '../dashboard/uploads/slider/'.$row['image'] ?>" style="height: auto;width: 300px;" alt="Slider Image" /></td>
      ...
      <div class="modal-body">
           	...
           	<div class="col-lg-12 p-t-20">
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											...
											<label class="mdl-textfield__label">Slider Image </label>
										</div>
									</div>
										<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
