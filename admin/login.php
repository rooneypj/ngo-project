...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>NGO Management |Admin Dashboard</title>
	<!-- google font -->
...
<body>
	<div class="limiter">
		<div class="container-login100 page-background" style="background: linear-gradient(to right, #4e54c8, whitesmoke);">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="" method="post">
					<span class="login100-form-logo" style="background-color:#fff;">
						<img alt="" src="../img/logo.jpg" style="width: 75px;">
					</span>
