   ...
   <div class="page-content">
    ...
    return $arr;
                           ...
                           <tr>
                              ...
                              <td><?php echo $row['address'];?>,<?php echo $row['state'];?>,<?php echo $row['pin'];?></td>
                             
                              
                              <td><?php echo $row['adhar'];?></td>
                              <td><a href="uploads/<?php echo $row['file'];?>" target="_blank"> ID View</a></td>
                              <td>
                            <?php
                                 if($status==0){
                                     ?>
                              ...
                              <button  type="submit"  name="user_deactive" class="btn btn-success btn-sm" onclick="return confirm('are you sure  want to deactive this');" >Active</button>
                              </form>
                              <?php
                                 }
                                 else{
                             ...
                             <form action="status_active.php" method="post">
                                      <input type="hidden" name="tid" value="<?php echo $row['id']?>">
                              <button  type="submit"  name="user_active" class="btn btn-info btn-sm" onclick="return confirm('are you sure  want to active this');" >Deactive</button>
                              </form>
